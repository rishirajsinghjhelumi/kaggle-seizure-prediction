...
OUTPUT_FILE = 'submissionFFTMean_30SVM2.csv';
...
for i = 1: 5
    ...
    train = sprintf('dog%d_train_fft_mean_30', i);
    label = sprintf('dog%d_label', i);
    test = sprintf('dog%d_test_fft_mean_30', i);
...
for i = 1:2
    ...
    train = sprintf('patient%d_train_fft_mean_30', i);
    label = sprintf('patient%d_label', i);
    test = sprintf('patient%d_test_fft_mean_30', i);
